...
class FilterStack:
    ...
    def calculate_initial_merit(self):
        ...
        #     elif (
        #         isinstance(polarization, (int, float)) and 0 <= float(polarization) <= 1
        #     ):
        #         # Lastly check if polarization is numeric and between [0, 1]
        #         converted_polarizations.append(float(polarization))
        #     else:
        #         raise ValueError(
        ...
        # print(self.target_polarization)
