...
// g++ -I/usr/include/eigen3 -I/usr/include/nlohmann -I/usr/include/sqlite3 -I/usr/local/include -I./include -shared -o interface.so interface.cpp FilterStack.cpp core.cpp input.cpp -fPIC -fopenmp -lsqlite3
