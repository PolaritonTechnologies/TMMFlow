...
int main()
{
    ...
    std::complex<double> kx(-0.002427175521633375, 0.0);
    std::complex<double> ky(0.0, 0.0);

    Eigen::Vector4cd v_kz{std::complex<double>(-0.01551931, 0.0), std::complex<double>(-0.01551931, 0.0), std::complex<double>(0.01551931, 0.0), std::complex<double>(0.01551931, 0.0)};

    Eigen::Matrix4cd m_e;
    m_e << std::complex<double>(0.98798985, 0.0), std::complex<double>(0.0, 0.0), std::complex<double>(-0.15451879, 0.0), std::complex<double>(0.0, 0.0),
        std::complex<double>(0.0, 0.0), std::complex<double>(1.0, 0.0), std::complex<double>(0.0, 0.0), std::complex<double>(0.0, 0.0),
        std::complex<double>(-0.98798985, 0.0), std::complex<double>(0.0, 0.0), std::complex<double>(-0.15451879, 0.0), std::complex<double>(0.0, 0.0),
        std::complex<double>(0.0, 0.0), std::complex<double>(1.0, 0.0), std::complex<double>(0.0, 0.0), std::complex<double>(0.0, 0.0);

    double d = 0.0;

    auto [v_a, v_b, m_a12, m_a34, m_b12, m_b34, m_c12, m_c34] = m_abc(k0, kx, ky, v_kz, m_e, d);
