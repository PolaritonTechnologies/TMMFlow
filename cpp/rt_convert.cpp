...
int main() {
    ...
    std::vector<Eigen::MatrixXcf> e_list_3x3 = {
        (Eigen::MatrixXcf(3, 3) << 
            std::complex<float>(-23.38459267, 4.76594931), std::complex<float>(0, 0), std::complex<float>(0, 0),
            std::complex<float>(0, 0), std::complex<float>(-23.38459267, 4.76594931), std::complex<float>(0, 0),
            std::complex<float>(0, 0), std::complex<float>(0, 0), std::complex<float>(-23.38459267, 4.76594931)).finished(),
        (Eigen::MatrixXcf(3, 3) << 
            std::complex<float>(2.25, 0), std::complex<float>(0, 0), std::complex<float>(0, 0),
            std::complex<float>(0, 0), std::complex<float>(2.25, 0), std::complex<float>(0, 0),
            std::complex<float>(0, 0), std::complex<float>(0, 0), std::complex<float>(2.25, 0)).finished()
    };
